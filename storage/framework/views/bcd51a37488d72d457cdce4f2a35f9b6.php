...
<?php endif; ?>
        ...
        <div
            ...
            <?php elseif(filament()->isSidebarFullyCollapsibleOnDesktop()): ?>
                ...
                x-bind:style="'display: flex; opacity:1;'" 
            <?php elseif(! (filament()->isSidebarCollapsibleOnDesktop() || filament()->isSidebarFullyCollapsibleOnDesktop() || filament()->hasTopNavigation())): ?>
                x-data="{}"
                x-bind:style="'display: flex; opacity:1;'" 
            <?php endif; ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /home/u643910891/domains/estaaqdem.com/public_html/vendor/filament/filament/src/../resources/views/components/layout/index.blade.php ENDPATH**/ ?>