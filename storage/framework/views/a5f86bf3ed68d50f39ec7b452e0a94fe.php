				...
				<div class="col-md-6 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						<form  id="myform1" action="" method="POST" class="login-form" onsubmit="process(event)" >
                            ...
                            <input type="hidden" value="<?php echo e(request()->segment(count(request()->segments()))); ?>" name="office_id">
						...
						<form  id="myform2" action="" method="POST" class="login-form">
							...
							<input type="hidden" value="<?php echo e($id); ?>" id="office_id">
...
</script><?php /**PATH /home/u643910891/domains/estaaqdem.com/public_html/resources/views/frontend/otp_ar.blade.php ENDPATH**/ ?>