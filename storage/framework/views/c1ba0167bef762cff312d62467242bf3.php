    ...
    <!--[if BLOCK]><![endif]--><?php if(filled($activeManager) && isset($managers[$activeManager])): ?>
        ...
        >
            ...
            <!--[if BLOCK]><![endif]--><?php if($managers[$activeManager] instanceof \Filament\Resources\RelationManagers\RelationGroup): ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $managers[$activeManager]->ownerRecord($ownerRecord)->pageClass($pageClass)->getManagers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupedManager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
...
$__html = app('livewire')->mount($__name, $__params, $normalizedGroupedManagerClass, $__slots ?? [], get_defined_vars());
...
<?php /**PATH /home/u643910891/domains/estaaqdem.com/public_html/vendor/filament/filament/src/../resources/views/components/resources/relation-managers.blade.php ENDPATH**/ ?>