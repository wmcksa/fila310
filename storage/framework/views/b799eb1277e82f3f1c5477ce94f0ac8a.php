    ...
    <div
        ...
        x-data="fileUploadFormComponent({
                    ...
                    confirmSvgEditingMessage:
                        '<?php echo e(__('filament-forms::components.file_upload.editor.svg.messages.confirmation')); ?>',
                    disabledSvgEditingMessage:
                        '<?php echo e(__('filament-forms::components.file_upload.editor.svg.messages.disabled')); ?>',
...
<?php $component->withAttributes(['class' => 'w-full']); ?>
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $groupedActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['xTooltip' => '{ content: ' . \Illuminate\Support\Js::from($action['label']) . ', theme: $store.theme }','xOn:click.stop.prevent' => ''.e($action['alpineClickHandler']).'','color' => 'gray','grouped' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-tooltip' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('{ content: ' . \Illuminate\Support\Js::from($action['label']) . ', theme: $store.theme }'),'x-on:click.stop.prevent' => ''.e($action['alpineClickHandler']).'','color' => 'gray','grouped' => true]); ?>
...
<?php endif; ?>
<?php /**PATH /home/u643910891/domains/estaaqdem.com/public_html/vendor/filament/forms/src/../resources/views/components/file-upload.blade.php ENDPATH**/ ?>